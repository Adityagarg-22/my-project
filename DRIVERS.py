...
Raw_DIR=r'C:\Users\hp\OneDrive\Documents\mrlEyes_2018_01\mrlEyes_2018_01'
for dirpath,dirname,filenames in os.walk(Raw_DIR):
    for i in tqdm([f for f in filenames if f.endswith('.png')]):

        if i.split('_')[4]=='0':
            shutil.copy(src=dirpath+'/'+i,dst=r'C:\Users\hp\OneDrive\Documents\prepared data\close eyes')

    
        elif i.split('_')[4]=='1':
             shutil.copy(src=dirpath+'/'+i,dst=r'C:\Users\hp\OneDrive\Documents\prepared data\open eyes')
...
mixer.init()
sound=mixer.Sound("D:\\DRIVERS DROWSINESS\\alarm.wav")
